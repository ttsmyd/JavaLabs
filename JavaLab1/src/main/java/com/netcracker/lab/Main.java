...
public class Main {
    public static void main(String[] args) {
     ...
     //   humanRepository.sortHumanRepository(humanRepository, insertSorter, birthComparator);
        ...
        System.out.println("\n\nИзначально объектом com.netcracker.lab.Human с индексом 3 был объект h3:");
        ...
        System.out.println("Был добавлен com.netcracker.lab.Human с индексом 3. Теперь на месте элемента с индексом 3:");
        System.out.println(humanRepository.getHuman(3).toString());
        System.out.println("\n\n\nВыведем весь репозиторий на экран:");
        writeOutForHumanRepository(humanRepository);

        System.out.println("\nУдалим новый объект com.netcracker.lab.Human находящийся под индексом 3");
